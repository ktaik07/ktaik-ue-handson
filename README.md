...
## Environments
- Preview: https://main--ktaik-ue-handson--ktaik07.aem.page/
- Live: https://main--ktaik-ue-handson--ktaik07.aem.live/
...
1. Open the `ktaik-ue-handson` directory in your favorite IDE and start coding :)
